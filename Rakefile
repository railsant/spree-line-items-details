...
desc 'Generate documentation for the line_items_details extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'LineItemsDetailsExtension'
...
desc 'Test the line_items_details extension.'
...
namespace :test do
  desc 'Functional test the line_items_details extension.'
  ...
  desc 'Unit test the line_items_details extension.'
